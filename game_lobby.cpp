...
class Lobby
{
    friend ostream &operator<<(ostream &os, const Lobby &aLooby);
...
ostream &operator<<(ostream &os, const Lobby &aLooby)
{
    Player *pIter = aLooby.m_pHead;
    os << "Here's who in the game lobby\n";
